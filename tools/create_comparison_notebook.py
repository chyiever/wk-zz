#!/usr/bin/env python3
"""Create the comparison notebook using Python with encoding='utf-8'."""
import json
...
cells.append(code([
    ...
    '# 配置\n',
    '# =========================\n',
    'DATA_FILE = Path(r"G:\\20260323_ZZ_pccp\\FIP\\24-900-1800\\test2\\0002341-500K-20260324T201052.39.tdms")\n',
    '\n',
...
# Cell 7: Method A - build-3 custom functions
cells.append(code([
    '# =========================\n',
...
# Cell 8: Method B - batch compute_all_features
cells.append(code([
    '# =========================\n',
