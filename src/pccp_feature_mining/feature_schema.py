...
BASE_FEATURE_MEANINGS = {
    ...
    "SK_max": "谱峭度最大值，短窗频谱四阶矩归一化的最大值，描述站退化频带的瞬态强度",
    "CF_res": "残差峰值因子，残差峰值与RMS之比，描述残差冲击峰值相对能量水平的突出程度",
    "T_half_high": "高频半衰期，高频包络从峰值衰减到一半所需时间，描述高频成分衰减快慢",
